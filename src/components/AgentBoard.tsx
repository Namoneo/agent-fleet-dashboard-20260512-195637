...
import { Cpu, MessageSquare, ArrowRight } from 'lucide-react';
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                {/* Actions */}
                <button className="opacity-0 group-hover:opacity-100 transition-all flex items-center gap-1 text-sm font-medium text-blue-600 hover:text-blue-700 px-3 py-1.5 rounded-lg hover:bg-blue-50">
                  {agent.status === 'idle' ? (
                    <>
